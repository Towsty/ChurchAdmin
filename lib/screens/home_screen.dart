      ...
      builder: (context, userSnapshot) {
        ...
        final initials =
            userName.trim().isNotEmpty
                ...
                : '?';
        final rawRole =
            (userData['role'] ?? 'visitor').toString().toLowerCase();
        final role = rawRole[0].toUpperCase() + rawRole.substring(1);
        final hasChurch =
            userData['churchId'] != null &&
            userData['churchId'].toString().isNotEmpty;
                ...
                children: [
                  ...
                  TextButton.icon(
                    onPressed: () {
                      setState(
                        () {},
                      ); // Triggers a rebuild to recheck user data
                    },
                  ...
                  if (const bool.fromEnvironment('dart.vm.product') ==
                    ...
                    ElevatedButton.icon(
                      onPressed: () async {
                        ...
                        // Ensure user has admin role in debug mode
                        try {
                          await FirebaseFirestore.instance
                              .collection('users')
                              .doc(user.uid)
                          ...
                          // Navigate to create church screen
                          if (mounted) {
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                          ...
                          if (mounted) {
                            ScaffoldMessenger.of(context).showSnackBar(
                              SnackBar(
                                content: Text(
                                  'Error setting debug permissions: $e',
                                ),
                              ),
                            );
                          }
                      ...
                      label: const Text('Create Test Church (Set Admin)'),
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          if (isAdmin)
                            StreamBuilder<int>(
                              stream:
                                  _joinRequestService.joinRequestCountStream(),
                              builder: (context, snapshot) {
                                  ...
                                  onTap: () {
                                    Navigator.push(
                                      ...
                                      MaterialPageRoute(
                                        builder:
                                            (_) =>
                                                const JoinRequestApprovalScreen(),
                                      ),
                                    );
                                  },
                                );
                          ...
                          LargeButton(
                            ...
                            onPressed: () {
                              Navigator.push(
                                ...
                                MaterialPageRoute(
                                  builder:
                                      (_) => const AttendanceHistoryScreen(),
                                ),
                              );
                            },
                          ),
